...
from .tables import TransactionTable, ActionRecordTable  # , ActionRecordTable
...
class PendingTransactionListView(SingleTableView, FilterView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['table_action'] = ActionRecordTable(ActionRecord.objects.filter(processed__exact=False).order_by('action_completed'), prefix="1-")
        return context
